...
ENDPOINT_TO_PORT_MAP = {
    ...
    "chat-llama-3-1-70b": (7405, "generate_text", None), # need to check vllm endpoint route
    "chat-llama-3-1-8b": (7105, "generate_text", None), # need to check vllm endpoint route
}
